...
// ToDo:
#define APPOINTMENTDURATION 30
#define CLINICSTARTTIMEINHOUR 10
#define CLINICENDTIMEINHOUR 14
#define CLINICSTARTTIMEINMINUTES 0
#define CLINICENDTIMEINMINUTES 0
